...
class HomePage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      //             return itemCategory(
      //                 context, categories[index].categoryName!, itemsMap[categories[index].categoryId], ref);
      //           }),
      //     ),
      //   ],
      // ),
  ...
  itemCategory(BuildContext context, String categoryTitle, List<ItemModel>? items, WidgetRef ref) {
